 ...
 * Deskripsi  : Main program untuk uji pajak tahunan
...
public class MManusia {
    public static void main(String[] args) {
        ...
        Petani pt1 = new Petani("Nugraha", LocalDate.of(1977,1,9), "Jl. Bunga 9", 5000000, "Wonogiri");
        PNS p2 = new PNS("Panji", LocalDate.of(2010,4,1), "Unknown", 10000000, "198004212010041002");
